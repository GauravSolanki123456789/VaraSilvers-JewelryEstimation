...
const questions = [
    ...
    { key: 'COMPANY_NAME', default: 'Jewellery Software', prompt: 'Company Name (white-label)' },
    { key: 'APP_TAGLINE', default: 'Estimations & Inventory', prompt: 'App Tagline (shown on login)' },
    { key: 'CLIENT_URL', default: 'http://localhost:3000', prompt: 'Client URL (for CORS/OAuth)' },
